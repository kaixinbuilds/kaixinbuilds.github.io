...
<title data-i18n="__TITLE_KEY__">Chun Kai Xin</title>
<meta name="description" data-i18n="site.description" data-i18n-attr="content" content="">
...
<link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><rect width='32' height='32' rx='4' fill='%231E2749'/><text x='16' y='23' font-family='Georgia,serif' font-size='20' fill='%23F6F1E6' text-anchor='middle'>k</text></svg>">
</head>
<body>
...
PAGES = {
  ...
  <section class="section" id="talks">
    <div class="wrap wrap-narrow">
      <h1 class="page-title" data-i18n="talks.title">Talks &amp; community</h1>
    ...
    <div class="wrap wrap-narrow">
      ...
      <figure class="specimen">
        <div class="specimen-plate">
          <img src="assets/art/prints/specimen.png" alt=""
